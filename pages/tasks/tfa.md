...
delivery: "2022/05/26"
order: 18
campus: "https://campusingenieriaytecnologia2223.ull.es/mod/assign/view.php?id=20448"
layout: Practica
...
* Alternatively you can do these two optional labs about extending Egg as TFA
  1. [Adding OOP to the Egg Parser](/practicas/egg-oop-parser)
  2. [Extending the Egg Interpreter](/practicas/extended-egg-interpreter)
...
You can present as TFA work the result of these two labs:
...
* [Example of Scope Analysis for Egg](/temas/scope-analysis/egg-scope-analysis.md) by David Afonso
