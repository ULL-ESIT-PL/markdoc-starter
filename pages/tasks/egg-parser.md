...
date: 2023/03/29
delivery: "2023/04/13"
campus: https://campusingenieriaytecnologia2223.ull.es/mod/assign/view.php?id=20466
order: 13
layout: Practica
prev: functions.md
...
temas:
  - text: Gramáticas Independientes del Contexto
    href: /temas/syntax-analysis/teoria.html#gramaticas-independientes-del-contexto
  - text: "ASTs: Árboles de Análisis Abstracto"
    href: "/temas/syntax-analysis/ast.html"
  - text: "The Design of Programming Languages"
    href: "/temas/syntax-analysis/the-design-of-programming-languages"
  - text: "Nearley.js"
    href: "/temas/syntax-analysis/earley/nearley"
  - text: Repo ULL-ESIT-PL/learning-nearley
    href: https://github.com/ULL-ESIT-PL/learning-nearley/
  - text: "Lexical Analysis with moo"
    href: "/temas/syntax-analysis/earley/moo"
---
...
Usando el generador de analizadores [Nearley.js](/temas/syntax-analysis/earley/nearley) escriba un parser para el [lenguaje Egg](/temas/syntax-analysis/teoria.html#gramaticas-independientes-del-contexto) que genere los árboles según la especificación que se describe en la sección [ASTs: Árboles de Análisis Abstracto](/temas/syntax-analysis/ast.html). Utilice el generador de analizadores léxicos [moo-ignore](/temas/syntax-analysis/earley/moo.html#skipping-tokens-in-moo) para la fase de análisis léxico.

Construya un paquete npm y 
publíquelo en [GitHub Registry](/temas/introduccion-a-javascript/creating-and-publishing-npm-module.html#what-is-github-registry) con ámbito `@ull-esit-pl-2223` y nombre el nombre del repo asignado.
